...
# -- From https://thevaluable.dev/fzf-git-integration/

# https://github.com/Phantas0s/the_valuable_dev_companion/blob/main/guide-fzf-git/fzf_git_commits.sh
function fgc() {
  local -r git_log=$(
    cat <<-EOF
...
# http://github.com/Phantas0s/the_valuable_dev_companion/blob/main/guide-fzf-git/fzf_git_branches.sh
...
# https://github.com/Phantas0s/the_valuable_dev_companion/blob/main/guide-fzf-git/fzf_git_files.sh
